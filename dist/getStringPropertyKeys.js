...
exports.getStringPropertyKeys = void 0;
/**
 ...
 *
 */
const getStringPropertyKeys = (keys) => {
    return keys; // Simply return the array of keys
};
exports.getStringPropertyKeys = getStringPropertyKeys;
